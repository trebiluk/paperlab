    ...
    steps: [
      {
        ...
        minutes: "3 min",
        visual: "square-cut",
        body: c("Fold a short edge onto a long edge. Cut the strip. Open the square.", "Keep the strip. A lid needs a second, slightly larger square.", "Two boxes need two squares. The lid is about 5 mm larger."),
      },
      {
        title: "Plus",
        minutes: "3 min",
        visual: "box-plus",
        body: c("Fold the top edge to the bottom edge. Press. Open it. Fold the left edge to the right edge. Press. Open it.", "Two book folds. They cross in the middle.", "You are marking the center without a ruler."),
      },
      {
        title: "Corners in",
        minutes: "3 min",
        visual: "box-blintz",
        body: c("Fold all four corners to the middle. You have a smaller square.", "Blintz. Crease hard.", "Wall height is about a quarter of the first square."),
      },
      {
        title: "Top and bottom marks",
        minutes: "3 min",
        visual: "box-edges",
        body: c("Fold the top edge to the middle line. Open it. Fold the bottom edge to the middle line. Open it.", "These creases are the wall hinges. Open them.", "Do not fold the side edges in yet."),
      },
      {
        title: "Open two flaps",
        minutes: "3 min",
        visual: "box-open",
        body: c("Unfold the top corner flap. Unfold the bottom corner flap. Leave the left corner and the right corner folded in.", "Two flaps stick out. Two stay in.", "If you unfold all four, start this step again."),
      },
      {
        title: "Cover the sides",
        minutes: "3 min",
        visual: "box-cover",
        body: c("Fold the top edge down on the mark. Fold the bottom edge up on the mark. They cover the side flaps.", "The edges you opened now fold back over the sides.", "These folds hold the side flaps down."),
      },
      {
        title: "Walls",
        minutes: "5 min",
        visual: "box-walls",
        body: c("Stand the top and the bottom up as walls. Fold each side triangle in. Tuck it into the side pocket. Do the other side.", "A box appears. No glue if the tucks stay.", "A slumped wall means a tuck is not in the pocket."),
      },
      {
        title: "The test",
        minutes: "4 min",
        visual: "box-fill",
        body: c("Put an eraser in the box. Hold it over the desk. Shake ten times. It should stay in, and the box should still open.", "Ten shakes. No glue on the walls if the folds lock.", "Too tight scuffs the eraser. Too loose dumps it."),
      },
    ],
    vocab: [
    ...
    steps: [
      {
        ...
        minutes: "2 min",
        visual: "frog-rect",
        body: c("Use a half sheet or an index card. Turn it so it is wide.", "A full long sheet makes a floppy frog.", "Copy paper is fine. Card stock hops farther."),
      },
      {
        title: "Middle",
        minutes: "2 min",
        visual: "frog-middle",
        body: c("Fold the left edge to the right edge. Press. Open it.", "The middle line stays.", "Later folds meet on this line."),
      },
      {
        title: "Head",
        minutes: "3 min",
        visual: "frog-head",
        body: c("Fold the top left corner to the middle line. Fold the top right corner to the middle line.", "The point is the head.", "The two corners should meet."),
      },
      {
        title: "Sides",
        minutes: "3 min",
        visual: "frog-sides",
        body: c("Fold the left edge to the middle line. Fold the right edge to the middle line.", "The body gets narrow.", "Keep the head point at the top."),
      },
      {
        title: "Bottom up",
        minutes: "2 min",
        visual: "frog-up",
        body: c("Fold the bottom edge up to the head.", "The flap covers the body.", "Crease it."),
      },
      {
        title: "Spring",
        minutes: "3 min",
        visual: "frog-spring",
        body: c("Fold the bottom half of that flap back down. The zigzag is the spring.", "Two creases, like a Z.", "This fold stores the hop."),
      },
      {
        title: "Hop",
        minutes: "4 min",
        visual: "frog-hop",
        body: c("Set it on the desk. Press the spring. Slide your finger off. Mark the landing. Do that three times.", "Press the spring, not the head.", "Write the three hops."),
      },
      {
        title: "One change",
        minutes: "4 min",
        visual: "iterate",
        body: c("Press the spring creases harder. Hop three more times.", "Only the spring changes.", "Did the hops get longer?"),
      },
    ],
    vocab: [
    ...
    steps: [
      {
        ...
        minutes: "3 min",
        visual: "square-cut",
        body: c("Fold a short edge onto a long edge. Cut the strip. Open the square.", "A rectangle will not open evenly.", "Keep the strip."),
      },
      {
        title: "Four corners",
        minutes: "3 min",
        visual: "teller-blintz",
        body: c("Fold all four corners to the middle.", "First blintz. Crease them.", "The points should meet."),
      },
      {
        title: "Turn over",
        minutes: "1 min",
        visual: "teller-flip",
        body: c("Turn the paper over. The plain side is up.", "Do not unfold the corners.", "The pockets are on the underside now."),
      },
      {
        title: "Four corners again",
        minutes: "3 min",
        visual: "teller-blintz2",
        body: c("Fold all four corners to the middle again.", "Second blintz, on the back.", "You have a smaller square."),
      },
      {
        title: "Two creases",
        minutes: "2 min",
        visual: "teller-crease",
        body: c("Fold it in half. Open it. Fold it in half the other way. Open it.", "These creases let it open both ways.", "Press, then open."),
      },
      {
        title: "Open",
        minutes: "3 min",
        visual: "teller-use",
        body: c("Slide one finger under each flap. Open it one way. Open it the other way.", "Four pockets. Two directions.", "If a flap will not open, that corner did not reach the middle."),
      },
      {
        title: "Words",
        minutes: "6 min",
        visual: "teller-use",
        body: c("Write four colors on the outside. Write numbers on the inside flaps. Write a tech word under each flap.", "Lab words, not fortunes about people.", "A partner should be able to read the word."),
      },
      {
        title: "A partner",
        minutes: "4 min",
        visual: "teller-use",
        body: c("A partner picks a color. Spell it while you open and close. They pick a number. Count. Open the flap. Read the word.", "They run it. You do not explain.", "If they get stuck, the colors or the numbers are missing."),
      },
    ],
    vocab: [
    ...
    steps: [
      {
        ...
        minutes: "3 min",
        visual: "copter-strip",
        body: c("Cut a strip about three fingers wide and as long as the page.", "One long rectangle.", "Rotor width is a parameter you can change later."),
      },
      {
        title: "The slit",
        minutes: "3 min",
        visual: "copter-slit",
        body: c("Cut a slit down the middle of the top half. Stop at the middle. You have two blades.", "Do not cut the strip in two.", "The stop is where the stem starts."),
      },
      {
        title: "The stem",
        minutes: "2 min",
        visual: "copter-stem",
        body: c("Fold the bottom up. That is the stem.", "Fold it up again if it is floppy.", "A paperclip can go on the stem later."),
      },
      {
        title: "The blades",
        minutes: "2 min",
        visual: "copter-blades",
        body: c("Fold one blade toward you. Fold the other blade away. From the top it looks like a T.", "Opposite folds. Same-side blades flutter.", "If both fold toward you, it will not spin."),
      },
      {
        title: "Drop",
        minutes: "4 min",
        visual: "copter-drop",
        body: c("Hold the stem. Blades up. Drop it. Count how long it stays up. Do that three times.", "Same height. Do not throw it.", "A throw is a different test."),
      },
      {
        title: "One change",
        minutes: "4 min",
        visual: "iterate",
        body: c("Add a paperclip to the stem, or cut the blades shorter. Drop three more times.", "One change. Same drop height.", "Write which one you changed."),
      },
    ],
    vocab: [
