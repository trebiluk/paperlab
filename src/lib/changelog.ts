...
export const UPDATES: ShopNote[] = [
  ...
  {
    date: "2026-09-26",
    title: "Sheets are cut sharp",
    items: [
      "Corners are square. A thick line is a cut. A dashed line between parts is a fold. Nothing on the page explains the line twice.",
    ],
  },
  {
    date: "2026-09-26",
    title: "Graph paper looks like graph paper",
    items: [
      "Card pictures sit on a ruled sheet: light squares, and a darker line every fifth square.",
    ],
  },
  {
    date: "2026-09-26",
  ...
  {
    date: "2026-09-26",
    title: "Berty’s later pictures match the words",
    items: [
      "The head is his face, not a diamond. The body step shows fold, then glue the head on. The last picture is Berty standing.",
    ],
  },
  {
    date: "2026-09-24",
    title: "Berty’s sheet prints",
    items: [
      "Bertybot is on the year path. Print the sheet at 100%, or trace it. Cut the thick line. Fold the dashes.",
    ],
  },
  {
    date: "2026-09-24",
